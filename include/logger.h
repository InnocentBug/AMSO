...
/**
 * @class Logger
 * @brief A simple logging class that writes log messages to a file or standard error.
 */
class Logger {
public:
    /**
     ...
     * @param filename The name of the file to log messages to. If empty, logs to standard error.
     */
     ...
     * @param filename The new file to log messages to. If empty, logs to standard error.
     */
